...
const NAME_CONFIG   = { xPercent: 11.6, yPercent: 48.5, fontSize: 28, font: 'helvetica', style: 'bold', color: [4, 46, 162], align: 'left' };
...
const CERTID_CONFIG = { xPercent: 82.5, yPercent: 35, fontSize: 11, font: 'helvetica', style: 'normal', color: [50, 50, 50], align: 'center' };
